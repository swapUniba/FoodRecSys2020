    ...
    <body data-spy="scroll" data-target="#navbar-nav-header" class="single-layout">
        ...
        if(isset($_POST['dish'])){
            ...
            if($dish == "main"){
                ...
                $answers = $sex . ":q," . $age . ":q," . $fatclass . ":q," . $health_style . ":q," . $health_condition . ":q," . $health_food_choise . ":q," . $control_nutritional_value . ":q," . $occupation . ":q," . $websiteUsage . ":q," . $cookingFreq . ":q," . $user_difficulty . ":q," . $goal . ":q," . $mood . ":q," . $activity . ":q," . $sleep . ":q," . $stress . ":q," . $depression . ":q," . $user_cost . ":q," . $user_time . ":q," ;
                ...
                $url_new = createURL($mood, $stress, $depression, $fatclass, $activity, $sleep, $vegetarian, $lactose, $gluten, $nickel, $light, $user_difficulty, $user_time, $user_cost, $age, $goal);
                ...
                */
                ...
                $answers = $answers . $data['personalized_main_1']['url'] . ','. $data['personalized_main_2']['url'] . ',' . $data['personalized_second_1']['url'] . ',' . $data['personalized_second_2']['url'] . ',' .$data['personalized_dessert_1']['url'] . ',' . $data['personalized_dessert_2']['url'] . ',';
                
            }
            else{
                $_var = $_POST["data"];
                $data = unserialize(base64_decode($_var));
            }
                ...
                <div class="inner container">
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex flex-row-reverse  ">
                            <span>Developed by Ivan Paparella</span>
                        </div>  
                    </div>
                </div>
            </footer>
