...
function getRecipes($pers_url){
    ...
    $not_pers_data_primo = performRequest("http://localhost:5002/mood/?fatclass=22&category=Primi%20piatti&&n=10&lang=en");
    
    $pers_data_secondo = performRequest(($pers_url."&category=Secondi%20piatti"));
    $not_pers_data_secondo = performRequest("http://localhost:5002/mood/?fatclass=22&category=Secondi%20piatti&&n=10&lang=en");
    
    $pers_data_dolce = performRequest(($pers_url."&category=Dolci"));
    $not_pers_data_dolce = performRequest("http://localhost:5002/mood/?fatclass=22&category=Dolci%20piatti&&n=10&lang=en");
