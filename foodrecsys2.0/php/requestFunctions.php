...
function getRecipes($pers_url_new, $pers_url_old){
    ...
    */
    ...
    $pers_data_primo_1 = performRequest(($pers_url_1."&category=Primi%20piatti"));
    $pers_data_primo_2 = performRequest(($pers_url_2."&category=Primi%20piatti"));
    
    $pers_data_secondo_1 = performRequest(($pers_url_1."&category=Secondi%20piatti"));
    $pers_data_secondo_2 = performRequest(($pers_url_2."&category=Secondi%20piatti"));

    $pers_data_dolce_1 = performRequest(($pers_url_1."&category=Dolci"));
    $pers_data_dolce_2 = performRequest(($pers_url_2."&category=Dolci"));
    
    return array("personalized_main_1" => $pers_data_primo_1, "personalized_main_2" => $pers_data_primo_2, "personalized_second_1" => $pers_data_secondo_1, "personalized_second_2" => $pers_data_secondo_2, "personalized_dessert_1" => $pers_data_dolce_1, "personalized_dessert_2" => $pers_data_dolce_2, "rec_1" => $rec_1, "rec_2" => $rec_2);
}
